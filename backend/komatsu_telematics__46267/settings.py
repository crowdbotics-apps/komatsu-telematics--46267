"""
Django settings for komatsu_telematics__46267 project.
...
ROOT_URLCONF = 'komatsu_telematics__46267.urls'
...
WSGI_APPLICATION = 'komatsu_telematics__46267.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "komatsu_telematics__46267 API",
    "DESCRIPTION": "API documentation for komatsu_telematics__46267 App",
    "VERSION": "v1",
}
